...
namespace AudioTool
{
    ...
    public sealed class AudioSession : IDisposable
    {
        ...
        private AudioUtilities.ISimpleAudioVolume GetAudioVolume()
        {
            return _ctl as AudioUtilities.ISimpleAudioVolume;
        }
        ...
        public float Volume
        {
            ...
            set
            {
                ...
                volume.SetMasterVolume(value, Guid.Empty);
            }
        }
        ...
        public bool Mute
        {
            ...
            set
            {
                ...
                volume.SetMute(value, Guid.Empty);
            }
        }
